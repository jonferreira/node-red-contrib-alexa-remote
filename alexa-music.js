var debug = false;
  ...
  module.exports = function(RED) {
    ...
    AlexaMusicNode = function(config) {
      var key, node, value;
        ...
        //return function(msg) {
            ...
            alexa.init({
                ...
                function (err) {
                    ...
                    alexa.playMusicProvider((msg.payload.serialOrName || node.serialOrName), (msg.payload.providerId || node.providerId), (msg.payload.searchPhrase || node.searchPhrase), function(error, result){
    ...
    RED.nodes.registerType("Alexa-music", AlexaMusicNode);
  };
